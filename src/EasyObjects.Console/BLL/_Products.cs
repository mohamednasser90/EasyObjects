...
namespace EasyObjects.Console.BLL
{
    ...
    public abstract class _Products : EasyObject
    {
        ...
        protected override DbCommand GetInsertCommand(CommandType commandType)
        {
            ...
            switch (commandType)
            {
                case CommandType.StoredProcedure:
                    ...
                    base.AddParameter(dbCommand, "ProductID", DbType.Int32, 0, ParameterDirection.Output, true, 0, 0, "ProductID", DataRowVersion.Default, Convert.DBNull);
        ...
        private void CreateParameters(DbCommand dbCommand)
        {
            ...
            base.AddInParameter(dbCommand, "UnitPrice", DbType.Currency, "UnitPrice", DataRowVersion.Current);
