...
namespace EasyObjects.Console.BLL
{
		...
		public override List<SchemaItem> SchemaEntries
        {
            get
            {
                if (_entries == null || _entries.Count == 0)
                {
                    ...
                    {
                        EmployeesSchema.EmployeeID,
                        EmployeesSchema.LastName,
                        EmployeesSchema.FirstName,
                        EmployeesSchema.Title,
                        EmployeesSchema.TitleOfCourtesy,
                        EmployeesSchema.BirthDate,
                        EmployeesSchema.HireDate,
                        EmployeesSchema.Address,
                        EmployeesSchema.City,
                        EmployeesSchema.Region,
                        EmployeesSchema.PostalCode,
                        EmployeesSchema.Country,
                        EmployeesSchema.HomePhone,
                        EmployeesSchema.Extension,
                        EmployeesSchema.Photo,
                        EmployeesSchema.Notes,
                        EmployeesSchema.ReportsTo,
                        EmployeesSchema.PhotoPath,
                    };
                }
	...
	public class _Employees : EasyObject
	{
		...
		public bool LoadByPrimaryKey(int employeeID)
		{
			switch(this.DefaultCommandType)
			{
				case CommandType.StoredProcedure:
					...
					{
						{ EmployeesSchema.EmployeeID.FieldName, employeeID },
					};
		...
		{	
			...
			switch(commandType)
			{
				case CommandType.StoredProcedure:
					...
					base.AddParameter(dbCommand, "EmployeeID", DbType.Int32, 4, ParameterDirection.Output, true, 0, 0, "EmployeeID", DataRowVersion.Default, Convert.DBNull);
				...
				case CommandType.Text:
					...
					{
						base.AddInParameter(dbCommand, "EmployeeID", DbType.Int32, "EmployeeID", DataRowVersion.Default);
					}
					else
					{
						base.AddParameter(dbCommand, "EmployeeID", DbType.Int32, 4, ParameterDirection.Output, true, 0, 0, "EmployeeID", DataRowVersion.Default, Convert.DBNull);
		...
		protected override DbCommand GetUpdateCommand(CommandType commandType)
		{
			...
			switch(commandType)
			{
				case CommandType.StoredProcedure:
					...
					base.AddInParameter(dbCommand, "EmployeeID", DbType.Int32, "EmployeeID", DataRowVersion.Current);
					CreateParameters(dbCommand);
		...
		{
			base.AddInParameter(dbCommand, "LastName", DbType.String, "LastName", DataRowVersion.Current);
			base.AddInParameter(dbCommand, "FirstName", DbType.String, "FirstName", DataRowVersion.Current);
			base.AddInParameter(dbCommand, "Title", DbType.String, "Title", DataRowVersion.Current);
			base.AddInParameter(dbCommand, "TitleOfCourtesy", DbType.String, "TitleOfCourtesy", DataRowVersion.Current);
			base.AddInParameter(dbCommand, "BirthDate", DbType.DateTime, "BirthDate", DataRowVersion.Current);
			base.AddInParameter(dbCommand, "HireDate", DbType.DateTime, "HireDate", DataRowVersion.Current);
			...
			base.AddInParameter(dbCommand, "HomePhone", DbType.String, "HomePhone", DataRowVersion.Current);
			base.AddInParameter(dbCommand, "Extension", DbType.String, "Extension", DataRowVersion.Current);
			base.AddInParameter(dbCommand, "Photo", DbType.Binary, "Photo", DataRowVersion.Current);
			base.AddInParameter(dbCommand, "Notes", DbType.String, "Notes", DataRowVersion.Current);
			base.AddInParameter(dbCommand, "ReportsTo", DbType.Int32, "ReportsTo", DataRowVersion.Current);
			base.AddInParameter(dbCommand, "PhotoPath", DbType.String, "PhotoPath", DataRowVersion.Current);
		}
...
#pragma warning restore IDE1006 // Naming Styles
		...
		public class WhereClause
		{
			...
			public WhereParameter EmployeeID => _EmployeeID_W ?? (_EmployeeID_W = TearOff.EmployeeID);
			public WhereParameter LastName => _LastName_W ?? (_LastName_W = TearOff.LastName);
			public WhereParameter FirstName => _FirstName_W ?? (_FirstName_W = TearOff.FirstName);
			public WhereParameter Title => _Title_W ?? (_Title_W = TearOff.Title);
			public WhereParameter TitleOfCourtesy => _TitleOfCourtesy_W ?? (_TitleOfCourtesy_W = TearOff.TitleOfCourtesy);
			public WhereParameter BirthDate => _BirthDate_W ?? (_BirthDate_W = TearOff.BirthDate);
			public WhereParameter HireDate => _HireDate_W ?? (_HireDate_W = TearOff.HireDate);
			...
			public WhereParameter HomePhone => _HomePhone_W ?? (_HomePhone_W = TearOff.HomePhone);
			public WhereParameter Extension => _Extension_W ?? (_Extension_W = TearOff.Extension);
			public WhereParameter Photo => _Photo_W ?? (_Photo_W = TearOff.Photo);
			public WhereParameter Notes => _Notes_W ?? (_Notes_W = TearOff.Notes);
			public WhereParameter ReportsTo => _ReportsTo_W ?? (_ReportsTo_W = TearOff.ReportsTo);
			public WhereParameter PhotoPath => _PhotoPath_W ?? (_PhotoPath_W = TearOff.PhotoPath);
		...
		public class AggregateClause
		{
			...
			#endregion
			public AggregateParameter EmployeeID => _EmployeeID_W ?? (_EmployeeID_W = TearOff.EmployeeID);
			public AggregateParameter LastName => _LastName_W ?? (_LastName_W = TearOff.LastName);
			public AggregateParameter FirstName => _FirstName_W ?? (_FirstName_W = TearOff.FirstName);
			public AggregateParameter Title => _Title_W ?? (_Title_W = TearOff.Title);
			public AggregateParameter TitleOfCourtesy => _TitleOfCourtesy_W ?? (_TitleOfCourtesy_W = TearOff.TitleOfCourtesy);
			public AggregateParameter BirthDate => _BirthDate_W ?? (_BirthDate_W = TearOff.BirthDate);
			public AggregateParameter HireDate => _HireDate_W ?? (_HireDate_W = TearOff.HireDate);
			...
			public AggregateParameter HomePhone => _HomePhone_W ?? (_HomePhone_W = TearOff.HomePhone);
			public AggregateParameter Extension => _Extension_W ?? (_Extension_W = TearOff.Extension);
			public AggregateParameter Photo => _Photo_W ?? (_Photo_W = TearOff.Photo);
			public AggregateParameter Notes => _Notes_W ?? (_Notes_W = TearOff.Notes);
			public AggregateParameter ReportsTo => _ReportsTo_W ?? (_ReportsTo_W = TearOff.ReportsTo);
			public AggregateParameter PhotoPath => _PhotoPath_W ?? (_PhotoPath_W = TearOff.PhotoPath);
